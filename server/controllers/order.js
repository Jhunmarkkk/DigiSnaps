...
export const createOrder = asyncError(async (req, res, next) => {
  ...
  <h1>Thank you for choosing DigiSnaps</h1>
...
const sendTransactionCompleteEmail = async (userEmail, orderId) => {
  try {
    ...
    await sendEmail({
      to: req.user.email,
      subject: "DigiSnaps - Order Confirmation",
      text: `<h1>Order Confirmed!</h1>
        ...
        <br/>
        <p>Thank you for choosing DigiSnaps. We appreciate your business and look forward to providing you with a seamless experience.</p>
        <br/>
        <p>Best Regards,</p>
        <p>DigiSnaps</p>`,
    });
